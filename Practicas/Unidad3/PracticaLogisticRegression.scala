...
//////////////////////////////////////////////////////////
// Complete las siguientes tareas que estan comentadas ////
/////////////////////////////////////////////////////////
...
//val logregdataall = (data.select(data("Clicked on Ad").as("label"), $"Age", $"Area Income",
...
val logregdataal = (data.withColumn("Hour",hour(data("Timestamp")))
    logregdataal = logregdataall.na.drop()
...
val assembler = (new VectorAssembler()
                  .setInputCols(Array("Daily Time Spent on Site","Age", "Area Income","SiDaily Internet Usage","Timestamp","Male"))
